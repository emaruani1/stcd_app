    ...
    try {
      ...
      for (const p of pledgesData) {
        ...
        pledgesByMember[p.memberId].push({
          ...
          canceledByName: resolveName(p.canceledBy),
          canceledByRole: p.canceledByRole || '',
      ...
      for (const t of txnsData) {
        ...
        txnsByMember[t.memberId].push({
          ...
          canceled: t.canceled || false,
          cancellationReason: t.cancellationReason || '',
          canceledBy: t.canceledBy || '',
          canceledByName: resolveName(t.canceledBy),
          canceledByRole: t.canceledByRole || '',
